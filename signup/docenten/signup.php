...
try{
$sql="INSERT INTO docent(idDocent,naam,tussenvoegsels,achternaam,email,wachtwoord)  VALUES ($idDocent,'$naam','$tussenvoegsels','$achternaam','$email','$wachtwoord')";
...
if ($resul === false) {
  ...
  <div class="popup">
        ...
        <a href="/fullstackproject/login/docenten/login.php">Log In!</a>
    </div>
    <!--Script-->
    <script>
...
<h1>Aanmelden</h1>  
  <input type="text" name="nummer" id="nm" placeholder="ID nummer"></br>
  <input type="text" name="name" id="nm" placeholder="Naam"></br>
  ...
  <input type="text" name="achternaam" id="ac" placeholder="Achternaam"></br>
   ...
   <input type="password" name="wachtword" id="ww" placeholder="Wachtword"></br>
<input type="submit" name="submitt" id='sb' value="Aanmelden">
<a href="/fullstackproject/login/docenten/login.php" id="acc">Heb je al een account?</a>
</form>
</div>
</div>
